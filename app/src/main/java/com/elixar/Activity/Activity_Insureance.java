...
import com.elixar.Adapter.Insureance_Adapter;
 ...
 */
public class Activity_Insureance extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener
{
    //class object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (cd.isConnectingToInternet())
                                        {
                                            ...
                                            SyncMethod("http://bmptechnologies.com/eelixar_api/get_insurence_plan.php");
        ...
        notification_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                String source_addr = actorsList.get(position).getid();
                Constants.store_insuarance_type=actorsList.get(position).gettitle();
                Toast.makeText(getApplicationContext(),"Selecting "+ Constants.store_insuarance_type+" Insurance Type", Toast.LENGTH_LONG).show();
                finish();
    ...
    public void init()
    {
        UF = new UserFunctions(Activity_Insureance.this);
        cd = new ConnectionDetector(Activity_Insureance.this);
                    ...
                    try {
                        ...
                        if (status.equalsIgnoreCase("true"))
                        {
                            ...
                            for(int i=0;i<array.length();i++)
                            {
                                ...
                                actorsList.add(new Doctortype_method(array.getJSONObject(i).getString("plan_id"),array.getJSONObject(i).getString("plan_type"),array.getJSONObject(i).getString("plan_title"),array.getJSONObject(i).getString("created_date")));
                            ...
                            if (getApplicationContext() != null)
                            {
                                ...
                                if (adapter == null)
                                {
                                    adapter = new Insureance_Adapter(getApplicationContext(),actorsList);
