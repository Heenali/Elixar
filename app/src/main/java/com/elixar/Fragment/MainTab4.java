 ...
 */
public class MainTab4 extends Act_TabBar {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(MainTab4.this);
